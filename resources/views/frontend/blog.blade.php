    ...
    <section class="bg-gray-50 py-16">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
                ...
                {{-- <div
                    class="bg-white rounded-2xl shadow border border-gray-100 hover:shadow-lg transition overflow-hidden group">
                    <!-- Parent div with padding -->
                    <div class="p-6 overflow-hidden rounded-2xl">
                    ...
                    <div class="pb-6 px-6">
                        ...
                        <a href="{{ route('blog.details') }}" class="btn-primary rounded-lg h-10">Read More <i
                                class="ph-bold ph-arrow-up-right"></i></a>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="p-6 overflow-hidden rounded-2xl">
                        <div class="aspect-[16/10] overflow-hidden rounded-2xl">
                            <a href="./blog-details.html"><img src="{{asset('frontend')}}/assets/img/about-1.jpg" alt="Blog 1"
                                    class="w-full h-full object-cover transform transition-transform duration-500 group-hover:scale-110"></a>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div class="p-6 overflow-hidden rounded-2xl">
                        <div class="aspect-[16/10] overflow-hidden rounded-2xl">
                            <a href="./blog-details.html"><img src="{{asset('frontend')}}/assets/img/about-2.jpg" alt="Blog 1"
                                    class="w-full h-full object-cover transform transition-transform duration-500 group-hover:scale-110"></a>
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div class="p-6 overflow-hidden rounded-2xl">
                        <div class="aspect-[16/10] overflow-hidden rounded-2xl">
                            <a href="./blog-details.html"><img src="{{asset('frontend')}}/assets/img/carousel-1.jpg" alt="Blog 1"
                                    class="w-full h-full object-cover transform transition-transform duration-500 group-hover:scale-110"></a>
                        </div>
                    </div>
                    ...
                    <div class="pb-6 px-6">
                        ...
                        <a href="./blog-details.html" class="btn-primary rounded-lg h-10 justify-center">Read More <i
                                class="ph-bold ph-arrow-up-right"></i></a>
                    </div>
                </div> --}}
