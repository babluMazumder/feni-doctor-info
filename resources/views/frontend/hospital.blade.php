                ...
                @foreach ( $hospitals as $hospital)
                    ...
                    <div
                        ...
                        <div
                            ...
                            <img src="{{ asset('frontend/assets/img/icons-hospital.png') }}"
                                class="w-full h-full rounded-full object-cover" alt="">
                        </div>

                        <h2 class="text-red-600 font-semibold text-lg mt-18">{{ $hospital->name }}</h2>
                        <h3 class="text-green-600 font-bold text-xl">Type:{{ $hospital->type }} </h3>
                        ...
                        <p class="text-green-600 font-semibold mb-6">registration no: {{ $hospital->registration_no }}</p>


                        <a href="tel:{{ $hospital->phone }}" class="btn-primary rounded-lg btn-black h-10">Call Now <i
