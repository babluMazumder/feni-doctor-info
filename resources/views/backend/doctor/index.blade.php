...
@section('title')
    {{ ___('label.doctor') }} {{ ___('label.list') }}
@endsection
@section('maincontent')
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href=""
                                        class="breadcrumb-link active">{{ ___('label.doctor') }}</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="j-parcel-main j-parcel-res">
                    <div class="card">
                        <div class="card-header mb-3">
                            ...
                            @if (hasPermission('doctor_create'))
                                <a href="{{ route('doctor.create') }}" class="j-td-btn"> <img
                                ...
                                <table class="table table-responsive-sm">
                                    <thead class="bg">
                                        <tr>
                                            ...
                                            <th>{{ ___('label.specialization') }}</th>
                                            <th>{{ ___('label.qualification') }}</th>
                                            <th>{{ ___('label.designation') }}</th>
                                            ...
                                            <th>{{ ___('label.profile_photo') }}</th>
                                            <th>{{ ___('label.slug') }}</th>
                                            <th>{{ ___('label.category') }}</th>
                                                        ...
                                                        <div class="input-group-prepend be-addon">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                @if (hasPermission('doctor_update'))
                                                                    <a href="{{ route('doctor.edit', $row->id) }}"
                                                                ...
                                                                @if (hasPermission('doctor_delete'))
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('doctor.delete', $row->id) }}"
