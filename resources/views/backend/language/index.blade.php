                                ...
                                <tr id="row_{{ $language->id }}">
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="{{ route('language.delete', $language->id) }}" onclick="tryDelete(event)" data-reload="{{true}}" data-remove-id="row_{{ $language->id }}" data-title="{{___('label.delete')}}" data-text="{{___('alert.this_action_cannot_be_reversed')}}" data-confirm-button-text="{{___('label.delete')}}" data-cancel-button-text="{{___('label.cancel')}}"> <i class="fa fa-trash"></i> {{ ___('label.delete') }} </a>
                                            @endif
                                        </div>
                                    </td>
                                    @endif
