        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('blooddonor.update',$bloodDonor->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-row">
                            <div class="form-group col-md-6 ">
                                <label>{{ ___('label.name') }} <span class="text-danger">*</span></label>
                                <input type="text" placeholder="{{ ___('placeholder.Name') }}" class="form-control input-style-1" name="name" value="{{ old('name', $bloodDonor->name) }}">
                                @error('name')
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <input type="email" class="form-control input-style-1 " name="email" placeholder="{{ ___('placeholder.email') }}" value="{{ old('email', $bloodDonor->email) }}">
                                @error('email') <p class="pt-2 text-danger">{{ $message }}</p> @enderror
                            </div>
                            <div class="form-group col-md-6 ">
                                <label>{{ ___('label.phone') }}<span class="text-danger">*</span></label>
                                <input type="text" class="form-control input-style-1 " name="phone" placeholder="{{ ___('placeholder.phone') }}" value="{{ old('phone', $bloodDonor->phone) }}">
                                @error('phone') <p class="pt-2 text-danger">{{ $message }}</p> @enderror
                            </div>
                            <div class="form-group col-md-6 ">
                                <label>{{ ___('label.address') }}<span class="text-danger">*</span></label>
                                <input type="text" class="form-control input-style-1 " name="address" placeholder="{{ ___('placeholder.address') }}" value="{{ old('address', $bloodDonor->address) }}">
                                @error('address') <p class="pt-2 text-danger">{{ $message }}</p> @enderror
                            </div>
                            <div class="form-group col-md-6 ">
                                <label>{{ ___('label.district') }}<span class="text-danger">*</span></label>
                                <input type="text" class="form-control input-style-1 " name="district" placeholder="{{ ___('placeholder.district') }}" value="{{ old('district', $bloodDonor->district) }}">
                                @error('district') <p class="pt-2 text-danger">{{ $message }}</p> @enderror
                            </div>
                            <div class="form-group col-md-6 ">
                                <label>{{ ___('label.last_donation_date') }}</label>
                                <input type="date" class="form-control input-style-1 " name="last_donation_date" placeholder="{{ ___('placeholder.last_donation_date') }}" value="{{ old('last_donation_date', $bloodDonor->last_donation_date) }}">
                            ...
                            <div class="col-md-6">
                                    ...
                                    <select name="gender" class="form-control input-style-1 select2">
                                        ...
                                        @foreach (Gender::cases() as $Gender)   
                                            <option value="{{ $Gender->value }}"  @selected(old('gender', $bloodDonor->gender?->value ?? null) == $Gender->value)>
                                                {{ $Gender->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                    ...
                                    <select name="blood_group" class="form-control input-style-1 select2">
                                        ...
                                        <option value=""></option>
                                            <option value="{{ $BloodGroup->value }}" @selected(old('blood_group', $bloodDonor->blood_group?->value ?? null) == $BloodGroup->value)>
                                                {{ $BloodGroup->label() }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                    ...
                                    <select name="availability" class="form-control input-style-1 select2">
                                        ...
                                        <option value=""></option> 
                                            <option value="{{ $availability->value }}"  @selected(old('availability', $bloodDonor->availability?->value ?? null) == $availability->value)>
                                                {{ $availability->value }}
                                            </option>
                                        @endforeach
                                    </select>
                              ...
                              <div class="col-md-6">
                                    ...
                                    <select name="status" class="form-control input-style-1 select2">
                                        @foreach (Status::cases() as $status)
                                            <option value="{{ $status->value }}" @selected(old('status', $bloodDonor->status?->value ?? null) == $status->value) >
                                                {{ $status->name }}
                                            </option>
                        ...
                        <div class="form-row">
                            <div class="j-create-btns">
                                <div class="drp-btns">
                                    ...
                                    <a href="{{ route('blooddonor.index') }}" class="j-td-btn btn-red"> <span>{{ ___('label.cancel') }}</span> </a>
                                </div>
                            </div>
                        </div>
                    </form>
