                    ...
                    <form action="{{ route('category.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 ">
                                ...
                                <input type="text" placeholder="{{ ___('placeholder.title') }}" class="form-control input-style-1" name="title" value="{{ old('title') }}">
                                @error('title')
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <input type="text" placeholder="{{ ___('placeholder.sub_title') }}" class="form-control input-style-1" name="sub_title" value="{{ old('sub_title') }}">
                                @error('sub_title')
                                <p class="pt-2 text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <input type="number" class="form-control input-style-1 " name="position" placeholder="{{ ___('placeholder.position') }}" value="{{ old('position') }}">
